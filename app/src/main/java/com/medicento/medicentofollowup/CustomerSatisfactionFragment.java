...
public class CustomerSatisfactionFragment extends Fragment {
    ...
    private ArrayList rowElements = new ArrayList<>(Arrays.asList(new PendingJobListElement("ABCD", "1234", "Att.@ 8:00AM", "Cx Satisfaction"),
            new PendingJobListElement("ABCDE", "1234", "Call.@ 9:00AM", "Cx Satisfaction"),
            new PendingJobListElement("ABCDF", "1234", "Att.@ 8:00AM", "Cx Satisfaction"),
            new PendingJobListElement("ABCDG", "1234", "Call.@ 8:30AM", "Cx Satisfaction"),
            new PendingJobListElement("ABCDH", "1234", "Att.@ 10:00AM", "Cx Satisfaction")));
